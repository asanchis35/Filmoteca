...
function informacion()
{
	...
	global $imdb;
		...
		$query = "SELECT imdb FROM actor WHERE concat (nombre,' ',apellidos) = ".'"'. $_POST["lista-actor"].'"';
		//echo "<br>";
		//echo $query;
...
function borrar_registro()
{
	...
	//echo $_POST["lista-actor"];
	
	//Se monta la Query para borrar el registro
	//$registro = $_POST["registro"];
	
	$query = "DELETE FROM actor WHERE concat (nombre,' ',apellidos) = ". '"'. $_POST["lista-actor"].'"';
...
?>
  ...
  <div class="container-fluid">
		...
		<h1 class="display-4 text-center mb-5">ACTORES</h1>
			<div class="row align-items-end">
				...
				<div class="col-3">
					<ul class="nav flex-column mb-5">
						...
						<li class="nav-item">
							<a class="nav-link active" href="#">Actor</a>
						</li>
						<li class="nav-item">
